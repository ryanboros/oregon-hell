...
export const EVENTS: IEvent[] = [
  ...
  },
  {
    ...
    products: [
      { id: 'food-20-50', item: FOOD_ITEM, qty: 20, price: 50 },
      { id: 'oxen-1-200', item: OXEN_ITEM, qty: 1, price: 200 },
      { id: 'firepower-2-50', item: FIREPOWER_ITEM, qty: 2, price: 50 },
      { id: 'crew-5-80', item: CREW_ITEM, qty: 5, price: 80 },
    ],
  },
  {
    type: EVENT_TYPES.shop,
    ...
    text: 'You have found a shop.',
    products: [
      { id: 'food-30-50', item: FOOD_ITEM, qty: 30, price: 50 },
      { id: 'oxen-1-200', item: OXEN_ITEM, qty: 1, price: 200 },
      { id: 'firepower-2-20', item: FIREPOWER_ITEM, qty: 2, price: 20 },
      { id: 'crew-10-80', item: CREW_ITEM, qty: 10, price: 80 },
    ],
  },
  {
    type: EVENT_TYPES.shop,
    ...
    products: [
      { id: 'food-20-60', item: FOOD_ITEM, qty: 20, price: 60 },
      { id: 'oxen-1-300', item: OXEN_ITEM, qty: 1, price: 300 },
      { id: 'firepower-2-80', item: FIREPOWER_ITEM, qty: 2, price: 80 },
      { id: 'crew-5-60', item: CREW_ITEM, qty: 5, price: 60 },
    ],
  },
  {
